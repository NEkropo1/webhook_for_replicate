...
from pyapns2.client import APNsClient, Credentials, CONCURRENT_STREAMS_SAFETY_MAXIMUM, Notification
from pyapns2.errors import ConnectionFailed
...
@patch('pyapns2.credentials.init_context')
@pytest.fixture
def client(mock_connection):
    with patch('pyapns2.credentials.HTTP20Connection') as mock_connection_constructor:
